...
def generate_pdf(image_path, paziente_info):
    ...
    # Report note
    report_note = """
    <b>REFERTO:</b> Rilevata una lieve ipoacusia si consiglia di approfondire lo stato del proprio udito con una visita in telemedicina
    """
